...
(function() {
  var Pipe, Task, async, asyncDone, browserSync, cache, catchGumpErrors, clean, combine, filter, globsToStream, gulp, handleDeletion, livereload, map, mark, memory, notify, once, parseArguments, path, pipe, plumber, promisify, reloadIfServed, rememberMarked, reportWrongUseOfWatch, run, runSingle, serving, shouldServe, subdir, tasks, unique, _ref,
    __slice = [].slice,
