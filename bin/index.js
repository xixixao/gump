...
(function() {
  var browserSync, cache, filter, gulp, livereload, notify, once, parseArguments, path, pipe, reportMissingSource, reportWrongUseOfWatch, serving, shouldServe, subdir, _ref,
    __slice = [].slice;
  ...
  _ref = './errors', reportMissingSource = _ref.reportMissingSource, reportWrongUseOfWatch = _ref.reportWrongUseOfWatch;
  ...
  exports.task = function() {
    var args, callback, deps, dest, name, pipes, src, _ref1;
  ...
  exports.watch = function() {
    var args, callback, deps, dest, name, pipes, src, srcs, _ref1;
    args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
